...
import { Search, Grid, List, SlidersHorizontal, Loader2, Upload, ArrowRight } from "lucide-react";
...
const materials = [
  ...
  { id: "abs", label: "ABS" },
  { id: "petg", label: "PETG" },
  { id: "nylon", label: "Nylon (Coming Soon)", disabled: true },
  { id: "resin", label: "Resin (Coming Soon)", disabled: true },
  { id: "metal", label: "Metal (Coming Soon)", disabled: true },
];
        ...
        <div className="container mx-auto px-6 py-12">
          ...
          >
            ...
            <p className="text-[var(--text-secondary)] mt-4 max-w-2xl">
              We specialize in custom 3D printing for your unique requirements.
              Upload your CAD file and get instant pricing for your parts.
            </p>
          </motion.div>
        </div>
      </div>
            ...
            {!loading && !error && filteredProducts.length === 0 && (
              <div className="text-center py-20">
                <div className="max-w-md mx-auto">
                  <div className="w-20 h-20 mx-auto mb-6 border border-[var(--accent)]/30 rounded-full flex items-center justify-center">
                    <Upload className="w-10 h-10 text-[var(--accent)]" />
                  </div>
                  <h3 className="text-2xl font-bold mb-4">Custom 3D Printing</h3>
                  <p className="text-[var(--text-secondary)] mb-8">
                    We specialize in custom 3D printing. Upload your CAD file and get an instant quote for your unique parts.
                  </p>
                  <Link href="/quote">
                    <button className="inline-flex items-center gap-2 px-8 py-4 bg-[var(--accent)] text-[var(--bg-primary)] font-semibold rounded-lg hover:bg-[var(--accent)]/90 transition-all">
